...
class BunnyBus extends EventEmitter{
    ...
    constructor(config) {
        ...
        if (!internals.instance) {
            ...
            internals.instance.promise = Promise;
        }
...
//need to destroy state and reevaluate when this happens
    ...
    get promise() {
        ...
        return internals.instance._promise;
    }
    ...
    set promise(promiseImplementation) {
        ...
        if (isResolvable && isThenable && isCatchable) {
            internals.instance._promise = promiseImplementation;
        }
    }
