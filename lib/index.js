...
class BunnyBus extends EventEmitter{
    ...
    async _getChannelContext(channelName) {
        ...
        if (channelContext && channelContext.channel && channelContext.connetionContext.connection) {
            return channelContext;
        }

        connectionContext = await $C.create(DEFAULT_CONNECTION_NAME, $.config);
