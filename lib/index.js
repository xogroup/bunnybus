...
class BunnyBus extends EventEmitter {
                                ...
                                this._dispatchers[this.config.dispatchType].push(
                                    ...
                                    async () => {
                                        ...
                                        await matchedHandler({
                                            ...
                                            metaData: parsedPayload.metaData,
                                            ack: this._ack.bind(this, { payload, channelName }),
                                            nack: this._nack.bind(this, { payload, channelName }),
    ...
    async _nack({ payload, channelName }) {
        ...
        const parsedPayload = Helpers.parsePayload(payload);
        parsedPayload.metaData.headers.nackedAt = new Date().toISOString();
        this.emit(BunnyBus.MESSAGE_NACKED_EVENT, parsedPayload.metaData, parsedPayload.message);
    }
