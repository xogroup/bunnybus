...
//need to destroy state and reevaluate when this happens
    ...
    //         //cache the exchange
    //         create_exchange: ['initialize', $.createExchange.bind($, globalExchange, 'topic', null)],
    ...
    //                     const routeKey = payload.fields.routingKey || message.event;
    ...
    //                     $._state.subscriptions[queue] = $._state.subscriptions[queue] || [];
    //                     $._state.subscriptions[queue].push({ consumerTag : result.consumerTag, handlers, options });
